...
@Builder
@Schema(description = "Таблица оценок: студенты × (задания + extra-колонка) с существующими ячейками")
public record GradingTableResponse(
        ...
        @Schema(description = "Строки таблицы — студенты") List<GradingTableStudent> students,
