...
/** Read-only доступ модуля grading к выданным правам (subject::domain) для таблиц оценок. */
public interface GradingPermissionRepository extends Repository<TeacherSubjectPermissionEntity, UUID> {
