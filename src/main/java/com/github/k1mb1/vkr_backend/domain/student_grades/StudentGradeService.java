...
public class StudentGradeService {
    ...
    public Page<StudentGradeResponse> findAll(
    ...
    public List<StudentGradeResponse> findAllByStudentIdAndSubjectId(
        UUID studentId,
        UUID subjectId
    ) {
        return studentGradeRepository
    ...
    @Transactional
    public List<StudentGradeResponse> bulkCreate(
        UUID lessonId,
        ...
        return request
            ...
            .map(item -> {
                ...
                var entity = StudentGradeEntity.builder()
                    ...
                    .build();
                return studentGradeMapper.toResponse(
    ...
    public StudentGradeResponse findById(UUID id) {
        return studentGradeRepository
            ...
            .map(studentGradeMapper::toResponse)
            .orElseThrow(() ->
                new EntityNotFoundException("Grade not found: " + id)
            );
    }
    ...
    @Transactional
    public StudentGradeResponse update(
        UUID id,
        UpdateStudentGradeRequest request
    ) {
        var entity = studentGradeRepository
            .findById(id)
            .orElseThrow(() ->
                new EntityNotFoundException("Grade not found: " + id)
            );
