...
/** Ссылки справочника teacher на подгруппы (group::domain) с проверкой принадлежности группе. */
public interface TeacherSubgroupRefRepository extends Repository<SubgroupEntity, UUID> {
