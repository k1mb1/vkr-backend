package com.github.k1mb1.vkr_backend.shared.web;

import static com.github.k1mb1.vkr_backend.shared.web.ErrorMessages.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handleValidation(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.status(BAD_REQUEST).body(ErrorDto.of(VALIDATION_FAILED, BAD_REQUEST, details));
    }
    ...
    public ResponseEntity<ErrorDto> handleTypeMismatch(MethodArgumentTypeMismatchException ex) {
        String details = ex.getRequiredType() != null ? "expected: " + ex.getRequiredType().getSimpleName() : null;
    ...
    public ResponseEntity<ErrorDto> handleUnexpected(Exception ex) {
        ...
        return ResponseEntity.status(INTERNAL_SERVER_ERROR).body(ErrorDto.of(INTERNAL_ERROR, INTERNAL_SERVER_ERROR));
    }
}
