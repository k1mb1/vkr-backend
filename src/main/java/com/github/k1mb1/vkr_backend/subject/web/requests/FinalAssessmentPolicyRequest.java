...
public record FinalAssessmentPolicyRequest(
        ...
        @Schema(description = "Банды по убыванию старшинства (первая — самая старшая)") @Valid List<Band> bands,
        ...
        @Schema(description = "SEPARATE + COUNT: минимальное количество посещённых занятий") @Min(0) Integer attendanceMinCount,
    ...
    public record Band(
            ...
            @Schema(description = "Ярлык, напр. «5», «зачтено»", requiredMode = Schema.RequiredMode.REQUIRED) @NotBlank String label,
