    ...
    implements SubjectAttendanceHighlightPolicyApi
{
    ...
    @Override
    public AttendanceHighlightPolicyResponse getAttendanceHighlightPolicy(
        UUID subjectId
    ) {
        ...
        return subjectMapper.toAttendanceHighlightPolicyResponse(
            subject.getAttendanceHighlightPolicy()
        );
    }
    ...
    public AttendanceHighlightPolicyResponse updateAttendanceHighlightPolicy(
        ...
        subject.setAttendanceHighlightPolicy(
            toAttendanceHighlightPolicy(request)
        );
        return subjectMapper.toAttendanceHighlightPolicyResponse(
     ...
     */
    private AttendanceHighlightPolicy toAttendanceHighlightPolicy(
        AttendanceHighlightPolicyRequest request
    ) {
        ...
        if (
            request.presentColor() == null ||
            request.lateColor() == null ||
            request.absentColor() == null ||
            request.excusedColor() == null
        ) {
            throw new IllegalArgumentException(
                "При включённой подсветке посещаемости (enabled=true) обязательны: " +
