 ...
 * <pre>
 *   COMBINED — посещаемость уже в total через AttendancePolicyEntity (поведение по умолчанию);
...
@NoArgsConstructor
@AllArgsConstructor
public class FinalAssessmentPolicyEntity extends BaseEntity {
    ...
    @Builder.Default
    List<AssessmentBandEntity> bands = new ArrayList<>();
