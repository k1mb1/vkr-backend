...
class TeacherSubjectPermissionService
    ...
    public TeacherSubjectPermissionResponse create(CreateTeacherSubjectPermissionRequest request) {
        var permission = TeacherSubjectPermission.builder()
            ...
            .allowedSubgroup(request.allowedSubgroupId() != null
    ...
    public TeacherSubjectPermissionResponse update(UUID id, UpdateTeacherSubjectPermissionRequest request) {
        ...
        if (request.groupId() != null) {
            permission.setGroup(groupReferenceService.getGroupReferenceById(request.groupId()));
        }
        if (request.allowedSubgroupId() != null) {
            permission.setAllowedSubgroup(groupReferenceService.getSubgroupReferenceById(request.allowedSubgroupId()));
        } else if (request.allowedSubgroupId() == null && permission.getAllowedSubgroup() != null) {
