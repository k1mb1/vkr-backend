...
public class TeacherSubjectPermissionsController {
    ...
    @GetMapping
    public ResponseEntity<List<TeacherSubjectPermissionResponse>> getPermissions(
        @RequestParam UUID subjectId
    ) {
        return ResponseEntity.ok(teacherSubjectPermissionsApi.getPermissions(subjectId));
    }
