 ...
 * </pre>
 * Признак штрафа/бонуса фронт вычисляет сам по {@code grade.lessonsOffset} и PenaltyPolicyEntity;
...
@NoArgsConstructor
@AllArgsConstructor
public class GradingHighlightPolicyEntity extends BaseEntity {
