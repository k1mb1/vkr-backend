...
/**
 * SPI авторизации, реализуемый модулем {@code subject}: снабжает auth данными о
 * выданных правах, не давая auth зависеть от бизнес-модулей (инверсия зависимостей —
