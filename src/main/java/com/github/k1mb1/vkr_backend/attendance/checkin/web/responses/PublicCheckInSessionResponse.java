...
@Schema(description = "Публичное состояние check-in сессии (для страницы студентов)")
public record PublicCheckInSessionResponse(
    ...
    @Schema(description = "Текущий момент сервера (UTC)")
    Instant serverNow,
    ...
    public record Student(
        ...
        @Schema(description = "Момент отметки, если есть")
        Instant checkedInAt
    ) {}
}
