...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handleEntityNotFound(
        ...
        return ResponseEntity.status(NOT_FOUND)
            .body(ErrorDto.of(ErrorCode.NOT_FOUND, ex.getMessage(), NOT_FOUND));
    }
    ...
    public ResponseEntity<ErrorDto> handleConstraintViolation(
        ...
        var fieldErrors = ex.getConstraintViolations().stream().map(v -> new FieldError(
    ...
    public ResponseEntity<ErrorDto> handleTypeMismatch(
        ...
        return ResponseEntity.status(BAD_REQUEST).body(ErrorDto.of(
    ...
    public ResponseEntity<ErrorDto> handleAccessDenied(
        ...
        return ResponseEntity.status(FORBIDDEN)
            .body(ErrorDto.of(ErrorCode.ACCESS_DENIED, ACCESS_DENIED, FORBIDDEN));
    }
    ...
    public ResponseEntity<ErrorDto> handleNoResource(
        ...
        return ResponseEntity.status(NOT_FOUND)
            .body(ErrorDto.of(ErrorCode.NOT_FOUND, RESOURCE_NOT_FOUND, NOT_FOUND));
    }
