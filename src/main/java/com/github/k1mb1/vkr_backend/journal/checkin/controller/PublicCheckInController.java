package com.github.k1mb1.vkr_backend.journal.checkin.controller;
...
import com.github.k1mb1.vkr_backend.journal.checkin.service.dto.request.PublicStudentSearchRequest;
import com.github.k1mb1.vkr_backend.journal.checkin.service.dto.request.StudentCheckInRequest;
import com.github.k1mb1.vkr_backend.journal.checkin.service.dto.request.VerifyCheckInCodeRequest;
import com.github.k1mb1.vkr_backend.journal.checkin.service.dto.response.PublicCheckInRecordResponse;
import com.github.k1mb1.vkr_backend.journal.checkin.service.dto.response.PublicCheckInSessionResponse;
import com.github.k1mb1.vkr_backend.journal.checkin.service.dto.response.PublicStudentResponse;
...
public class PublicCheckInController {
    ...
    final CheckInRecordService checkInRecordService;
    ...
    public ResponseEntity<PublicCheckInSessionResponse> getPublicCheckInSession(
        ...
        return ResponseEntity.ok(checkInSessionService.getPublic(id));
    }
    ...
    public ResponseEntity<Void> verifyCheckInCode(
        ...
        checkInSessionService.verifyCode(id, request.code());
    ...
    public ResponseEntity<List<PublicStudentResponse>> searchPublicCheckInStudents(
        ...
        return ResponseEntity.ok(checkInSessionService.searchStudents(id, request.code(), request.query()));
    }
    ...
    public ResponseEntity<PublicCheckInRecordResponse> submitCheckIn(
        ...
        return ResponseEntity.ok(checkInRecordService.checkIn(id, request));
    }
}
