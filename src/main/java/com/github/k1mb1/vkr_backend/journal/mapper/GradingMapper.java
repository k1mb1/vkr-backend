...
import com.github.k1mb1.vkr_backend.journal.domain.AssignmentAdmissionTier;
...
import com.github.k1mb1.vkr_backend.journal.service.dto.response.GradingTableStudentResponse;
...
public interface GradingMapper {
    ...
    GradingTableStudentResponse toTableStudent(LessonStudentResponse student);
